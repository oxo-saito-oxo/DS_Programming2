...
def fetch_and_save_weather_forecast(area_code):
    ...
    print(f"Fetching data from URL: {url}")  # URLの確認のためにプリント
    try:
...
# 元のUIをほとんど変更せずに維持しつつ、データベースアクセスを組み込みます
...
def main(page: ft.Page):
    ...
    page.window.width = 800  # 警告メッセージの修正
